export const Hero = () => {
	return (
		<div className="text-white  grid grid-cols-4 grid-rows-10 gap-4">
			<div className="p-10 bg-black rounded-3xl text-center">
			...
			<div className="p-10 bg-black rounded-3xl flex items-center row-span-3">
				<h1 className="text-8xl text-purple-500">About</h1>
			</div>
			<div className="p-10 bg-black flex items-end rounded-3xl row-span-3">
				<h1 className="text-9xl text-red-500">Features</h1>
			</div>
			<div className="p-10 bg-purple-500 text-black rounded-3xl row-span-2 col-span-2">
				<h1 className="text-9xl">About Section</h1>
			</div>
			<div className="p-10  rounded-3xl bg-red-500 text-black">
				<h1 className="text-9xl">naoo</h1>
			</div>
			<div className="p-10 rounded-3xl bg-red-500 text-black">
				<h1 className="text-9xl">naoo</h1>
			</div>
