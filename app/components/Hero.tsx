	...
	return (
		<div className="text-white  grid grid-cols-4 grid-rows-11 gap-4">
			...
			<div className="p-10 text-black  rounded-3xl col-span-3 flex flex-col gap-2 justify-center bg-cyan-500">
				<h1 className="text-8xl whitespace-wrap text-balance">{`I'm`}</h1>
				<h1
					onMouseEnter={() => descMouseEnter({ img: data.personal.img })}
					onMouseLeave={descMouseLeave}
					className=" text-8xl whitespace-nowrap  text-balance"
				>{`Anakin Skywalker.`}</h1>
			</div>
			<div className="p-10 bg-cyan-500 text-black flex flex-col  gap-2 rounded-3xl col-span-3">
				<h1
					className="text-9xl"
					onMouseEnter={() =>
						logoMouseEnter({ height: 150, width: 150, radius: "100%" })
					}
			...
			<div className="p-10 bg-black rounded-3xl flex flex-col items-center row-span-2">
				{Array.from({ length: 7 }).map((_, i) => (
					<h1
						...
						onMouseEnter={() =>
							logoMouseEnter({ height: 100, width: 100, radius: "100%" })
						}
						onMouseLeave={logoMouseLeave}
					>
						#CODE
			...
			<div className="px-20 bg-purple-500  items-center justify-center text-black flex flex-col gap-4 rounded-3xl row-span-2 col-span-2">
				<h2
					onMouseEnter={() =>
						logoMouseEnter({ height: 300, width: 300, radius: "100%" })
					}
					onMouseLeave={logoMouseLeave}
			...
			<div
				onMouseEnter={() =>
					logoMouseEnter({ height: 200, width: 200, radius: "100%" })
				}
				onMouseLeave={logoMouseLeave}
				className="p-10 bg-black flex  flex-col rounded-3xl row-span-2"
			>
			...
			<div className="p-10  bg-green-500 text-black rounded-3xl col-span-2 ">
				<h1
					...
					onMouseLeave={logoMouseLeave}
				>{`ON THE RIGHT ARE THE SKILLS I'M KNOWN FOR`}</h1>
			</div>
			...
			<div className="p-10 bg-black text-pink-500 rounded-3xl flex items-end  row-span-2">
				...
				>{`Let's SEE What My  clients has to say.`}</h1>
			</div>
			<div className="p-10 bg-green-500 rounded-3xl   ">
				<h1
					...
					onMouseLeave={logoMouseLeave}
				>
					And you are still not Impressed?
				</h1>
				<h1
					onMouseEnter={() =>
						logoMouseEnter({ height: 200, width: 200, radius: "100%" })
			...
			<div className="p-10 text-yellow-500 flex flex-col justify-evenly bg-black rounded-3xl  row-span-3 ">
				<h1
					...
					onMouseLeave={logoMouseLeave}
					className="text-8xl inline-block text-white"
				>
				...
				<h1
					...
					onMouseLeave={logoMouseLeave}
					className="text-8xl text-blue-700 inline-block"
				>
					see my WORK then.
				</h1>
			</div>
					...
					{data.projects.data.slice(0, 5).map((project, i) => (
						<div className="" key={i}>
							<h1
								...
								onMouseEnter={() => descMouseEnter({ img: project.img })}
								onMouseLeave={descMouseLeave}
							>
								@{project.title}
							</h1>
			...
			<div className="p-10 bg-white text-black rounded-3xl   ">
				<h1
					className="text-6xl"
					onMouseEnter={() =>
						logoMouseEnter({ height: 100, width: 100, radius: "50%" })
					}
					onMouseLeave={logoMouseLeave}
				>
					Like What you SEE?
			...
			<div className="p-10 bg-black rounded-3xl  col-span-3">
				<form className="flex flex-col gap-2 items-center">
					...
					<button
						id="send-button"
						onMouseEnter={() => buttonMouseEnter({ id: "send-button" })}
